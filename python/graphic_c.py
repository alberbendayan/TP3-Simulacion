...
def main():
    ...
    plt.title("Choques contra obstáculo")
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
    ...
    print(f"Choques totales: {total[-1]}")
    print(f"Choques distintos: {distintos[-1]}")
    print(f"Partículas que nunca chocaron: {config['particle_count'] - distintos[-1]}")
